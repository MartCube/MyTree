<template>
	<div class="container">
		<titleBar>{{ $t('menu.my_shop.self_name') }}</titleBar>
		...
		<div class="menu_links">
			<nuxt-link class="item" :to="localePath('/myShop/editShop')">
				...
				<span>{{ $t('menu.my_shop.edit_shop') }}</span>
			</nuxt-link>
			<nuxt-link class="item" :to="localePath('/myShop/statistics')">
				<svg class="icon" viewBox="0 0 24 24">
				...
				<span>{{ $t('menu.my_shop.statistics') }} </span>
			</nuxt-link>
			<nuxt-link class="item" :to="localePath('/myShop/QRcode')">
				<svg class="icon" viewBox="0 0 24 24">
				...
				<span>{{ $t('menu.my_shop.download_qr') }}</span>
			</nuxt-link>
		</div>
	</div>
</template>
