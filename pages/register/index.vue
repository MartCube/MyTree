<template>
	<div class="container">
		...
		<div class="register">
			<div v-show="!showSignUp" class="intro">
				<btn @click.native="ShowSignUp">Create Account</btn>
				<btn fill> <i class="icon icon-google" /> Sign up with Google</btn>
				<btn fill> <i class="icon icon-github" /> Sign up with Github</btn>
				<n-link to="/login">Already have an account ?</n-link>
			</div>
...
export default {
	...
	methods: {
		...
		ShowSignUp() {
			...
			slideRight(document.querySelectorAll('.register .signup'))
		},
		async Submit() {
