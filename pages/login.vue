		...
		<div class="auth">
			<transition name="fade" mode="out-in" tag="div">
				<div v-if="intro" class="intro">
					<btn>Sign Up</btn>
					<btn fill @click.native="signIn">Sign In</btn>
			...
			<transition name="fade" mode="out-in" tag="div">
				<div v-if="signin" class="signin">
					...
					<btn @click.native="goBack">Sign up</btn>
				</div>
			</transition>
		</div>
